...
public class ObjectsListPageTests extends TestBaseRemote {
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Owner("Yulia Azovtseva")
    void successfulNewObjectCreationTest (String name, String address, String type, String parent) {
    ...
    @Owner("Yulia Azovtseva")
    void successfulSearchByAddressUsingTheMainSearchInputTest(String address) {
        step("Open 'Objects' page", () ->
                objectsListPage.openPage()
        );
    ...
    @Severity(SeverityLevel.NORMAL)
    @Owner("Yulia Azovtseva")
    void successfulSearchByAddressUsingSidebarFilterTest(String address) {
        step("Open 'Objects' page", () ->
                objectsListPage.openPage()
        );
    ...
    @Severity(SeverityLevel.NORMAL)
    @Owner("Yulia Azovtseva")
    void successfulFilteringByLevelUsingUpperLevelFilterTest(String level) {
        step("Open 'Objects' page", () ->
                objectsListPage.openPage()
        );
